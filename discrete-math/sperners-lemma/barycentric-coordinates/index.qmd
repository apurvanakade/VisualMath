...
Why does this work? Write $T$ for the affine map sending $(0,0) \mapsto A$, $(1,0) \mapsto B$, $(0,1) \mapsto C$. Being affine, $T$ preserves weighted combinations whose coefficients sum to 1:
$$
T\big((1-x-y)(0,0) + x(1,0) + y(0,1)\big) = (1-x-y)\,T(0,0) + x\,T(1,0) + y\,T(0,1) = (1-x-y)A + xB + yC.
$$
