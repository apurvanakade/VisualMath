...
(function attachVM(globalThis) {
  ...
  // This is the CDF of a Gamma(s, 1) variable, and the chi-square CDF is
  // P(df/2, x/2) -- so it's what turns an observed chi-square statistic into
  // a p-value.
  //
  ...
  const regularizedGammaP = (s, x) => {
    ...
    const logPrefactor = -x + s * Math.log(x) - globalThis.VM.stats.logGamma(s);
  ...
  globalThis.VM = { ...globalThis.VM, stats: { ...globalThis.VM?.stats, regularizedGammaP } };
})(window);
