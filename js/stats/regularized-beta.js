...
(function attachVM(globalThis) {
  ...
  const regularizedBetaI = (x, a, b) => {
    ...
    const logBeta = globalThis.VM.stats.logGamma(a) + globalThis.VM.stats.logGamma(b) - globalThis.VM.stats.logGamma(a + b);
  ...
  globalThis.VM = { ...globalThis.VM, stats: { ...globalThis.VM?.stats, regularizedBetaI } };
})(window);
