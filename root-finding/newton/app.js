...
/**
 * Assemble the Newton page API from its method-local parts.
 */
(function attachNewtonApp(globalThis) {
  const methodAppUtils = globalThis.VisualMathMethodAppUtils
  const app = globalThis.VisualMathNewtonAppParts

  globalThis.VisualMathNewtonApp = methodAppUtils.createMethodApp({
    compute: app.compute,
